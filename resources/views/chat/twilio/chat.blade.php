...
<div class="container" id="app">
    <div class="row"> 
        ...
        <div class="col-2 d-flex" style="justify-content: space-around;">
            <a href="https://www.twilio.com/blog/add-chat-laravel-php-app-twilio-chat">Tutorial</a>
        </div> 
    ...
    <div class="container p-0">
			<div class="row g-0">
				...
				<twilio-chat-component :auth-user="{{ $authUser }}" :other-user="{{ $otherUser }}" :chat="{{ $chat }}"> </twilio-chat-component>
			</div>
	</div>
</main>
</div>
