        ...
        <div class="col-3 d-flex" style="justify-content: space-around;">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item" href="{{ asset('docs/twilio_setup.docx') }}" class="text-right">Tài
                            liệu</a></li>
                    ...
                    <div class="py-2 px-4 border-bottom d-none d-lg-block">
                        <div class="d-flex align-items-center py-1">
                            <div class="position-relative">
                                <img src="{{ asset('img/avatar3.png') }}" class="rounded-circle mr-1" width="40"
                                     height="40">
                            </div>
                    ...
                    <div class="position-relative">
                        <div class="chat-messages p-4">
                            <div class="chat-message-right pb-4">
                                <div>
                                    <img src="{{ asset('img/avatar1.png') }}" class="rounded-circle mr-1" width="40"
                                         height="40">
