...
<div class="container pt-5">
    <div class="row">
        ...
        <div class="col-1 d-flex" style="justify-content: space-around;">
            <a href="https://spatie.be/docs/image/v1/image-manipulations/resizing-images">Tutorial</a>
        </div>
        <div class="col-12 mt-4">
            <div class="card p-3 df">
                <img src="{{ asset('img/spatie.png') }}" class="h50">
            </div>
        </div>
    </div>

    <form action="/image/spatie/upload" method="post" class="text-center mt-5" enctype="multipart/form-data">
        @csrf
