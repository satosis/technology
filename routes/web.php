...
use App\Http\Controllers\Backend\Chat\LivechatController;
...
use App\Http\Controllers\Backend\Payment\OxapayController;
...
Route::group(['prefix' => 'payment','middleware' => 'auth'],
    function () {
        ...
        Route::get('/oxapay', [OxapayController::class, 'index']);
    }
);
